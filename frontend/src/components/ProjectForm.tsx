...
import type { Project, ProjectInput, ProjectFieldLabel, ProjectFieldKind } from '../lib/api'
...
export function toBody(f: ProjectForm): ProjectInput {
  return {
...
export default function ProjectForm({ form, setForm, fieldLabels, customerOptions }: Props) {
  ...
  const renderField = (l: ProjectFieldLabel) => {
    const i = l.idx - 1

"""Schemas for real-estate projects (core basic data + configurable
params/numbers/flags/lists)."""
from datetime import datetime, date

from pydantic import BaseModel, ConfigDict


class RealEstateProjectIn(BaseModel):
    ...
    params: list[str | None] = []      # 15 text
    numbers: list[float | None] = []   # 15 numeric
    flags: list[bool] = []             # 5 yes/no
    lists: list[str | None] = []       # 10 single-choice


class RealEstateProjectOut(BaseModel):
